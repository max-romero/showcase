...
# AI Application
The agent works with your existing code. It extracts business descriptions from docstrings (if you have them) and infers purpose from file names and code structure. You can optionally add docstrings to get more accurate business descriptions in the generated diagrams, but it's not required.
